    ...
    for (let i = 0; i < files.length; i++) {
        ...
        switch(extension){
            case 'png':
                ...
                '</a>';*/
                var link = '<div class="img-grid-c">'+
                        '<a class="imglink" href="" download alt="'+filename+'">'+
                        '<img src="'+URL.createObjectURL(files[i])+'"></a>'+
                    '</div>';
                break;
            case 'jpg':
                /*var link = '<a href="" download>'+
                ...
                '</a>';*/
                var link = '<div class="img-grid-c">'+
                        '<a class="imglink" href="" download>'+
                        '<img src="'+URL.createObjectURL(files[i])+'" alt="'+filename+'"></a>'+
                    '</div>';
                break;
            case 'docx':
                /*var link = '<a href="" download>'+
                ...
                var link = '<div class="img-grid-c">'+
                        '<a class="imglink" href="" download>'+
                        '<img src="'+url + '/img/icons/docx.png'+'" alt="'+filename+'"></a>'+
                    '</div>';
                break;
            case 'doc':
                /*var link = '<a href="" download>'+
                ...
                var link = '<div class="img-grid-c">'+
                        '<a class="imglink" href="" download>'+
                        '<img src="'+url + '/img/icons/doc.png'+'" alt="'+filename+'"></a>'+
                    '</div>';
                break;
            case 'pdf':
                /*var link = '<a href="" download>'+
                ...
                var link = '<div class="img-grid-c">'+
                        '<a class="imglink" href="" download'+
                        '<img src="'+url + '/img/icons/pdf.png'+'" alt="'+filename+'"></a>'+
                    '</div>';
                break;
        }
