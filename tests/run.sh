...
sudo -u ec2-user composer update > s3://s3intercambio2/ECESaaSUACJ/logs/composer.txt  > /dev/null 2> /dev/null < /dev/null &
php artisan migrate --force > s3://s3intercambio2/ECESaaSUACJ/logs/migrate.txt > /dev/null 2> /dev/null < /dev/null &
