...
class ConsultaController extends Controller
{
    ...
    */
    ...
    public function registrar($pacid){
        ...
        return view('consultageneral.registroconsulta', [
        'paciente' => $pac, 'age' => $age, 'years' => $years, 'grupos' => $grupos, 'sexos' => $sexos, 'inter' => $inter,
        'anteHF' => $anteHF, 'antePP' => $antePP, 'antePNP' => $antePNP, 'interAS' => $interAS, 'tiposDif' => $tiposDif,
    ...
    public function continuar($consulta_id)
    {
        ...
        return view('consultageneral.continuarconsulta', [
            'paciente' => $pac, 'age' => $age, 'years' => $years, 'consulta' => $consulta,
    ...
    public function view($consulta_id)
    {
        ...
        return view('consultageneral.viewconsulta', [
            'paciente' => $pac, 'age' => $age, 'consulta' => $consulta,
            'grupos' => $grupos, 'inter' => $inter, 'exploracion' => $explo, 'anteHF' => $anteHF, 'antePP' => $antePP,
