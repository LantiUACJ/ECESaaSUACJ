                ...
                <div class="col s6 vcenter righttop">
                    @if (Route::has('login'))
                        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                            @auth
                                <a href="{{ url('/home') }}" class="rightbtn">Inicio</a>
                            @else
                ...
                <div class="row fh">
                    <div class="col s12 m12 nomargin">
                        <div class="text-content text-center">
                            <img src="{{ asset('img/logoprep2.png') }}" class="logo logo-center" alt=""> <br>
                            <a class="waves-effect waves-light btn" href="{{ route('login') }}">Iniciar sesión</a>
                        </div>
                    </div>
                </div>
