...
@section('content')
    ...
    <h5 class="section-title title">Continuar consulta</h5>
    <p class="breadcrumbs">
                            ...
                            <div class="col s12">
                                <div class="row no-mar bg-tab">
                                    <div class="input-field col s12 m6 l6 txtarin no-mar">
                                        <textarea name="motivo" id="motivo" cols="30" rows="10" maxlength="255"">{{ $consulta->motivoConsulta }}</textarea>
                                    ...
                                    <div class="input-field col s12 m6 l6 txtarin no-mar">
                                        <textarea name="cuadro" id="cuadro" cols="30" rows="10" maxlength="255"">{{ $consulta->cuadroClinico }}</textarea>
                                                    ...
                                                    <div class="question">
                                                        ...
                                                        <p>
                                                            <label for="consultaembarazo1">
                                                                <input name="consultaembarazo" id="consultaembarazo1" value="0" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->relacionConsulta == 0? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>Primera vez</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label for="consultaembarazo2">
                                                                <input name="consultaembarazo" id="consultaembarazo2" value="1" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->relacionConsulta == 1? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                    ...
                                                    <div class="question">
                                                        ...
                                                        <p>
                                                            <label for="trimestreembarazo1">
                                                                <input name="trimestreembarazo" id="trimestreembarazo1" value="0" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->trimestre == 0? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>Primer trimestre</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label for="trimestreembarazo2">
                                                                <input name="trimestreembarazo" id="trimestreembarazo2" value="1" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->trimestre == 1? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>Segundo trimestre</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label for="trimestreembarazo3">
                                                                <input name="trimestreembarazo" id="trimestreembarazo3" value="2" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->trimestre == 2? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                    ...
                                                    <div class="question">
                                                        ...
                                                        <p>
                                                            <label for="riesgoembarazo1">
                                                                <input name="riesgoembarazo" id="riesgoembarazo1" value="0" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->altoRiesgo == 0? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>No</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label for="riesgoembarazo2">
                                                                <input name="riesgoembarazo" id="riesgoembarazo2" value="1" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->altoRiesgo == 1? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>Sí</span>
                                                            </label>
                                                        </p>
                                                    ...
                                                    <div class="question">
                                                        ...
                                                        <p>
                                                            <label for="diabetesembarazo1">
                                                                <input name="diabetesembarazo" id="diabetesembarazo1" value="0" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->diabetes == 0? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>No</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label for="diabetesembarazo2">
                                                                <input name="diabetesembarazo" id="diabetesembarazo2" value="1" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->diabetes == 1? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>Sí</span>
                                                            </label>
                                                        </p>
                                                    ...
                                                    <div class="question">
                                                        ...
                                                        <p>
                                                            <label for="infeccionembarazo1">
                                                                <input name="infeccionembarazo" id="infeccionembarazo1" value="0" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->infeccionUrinaria == 0? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>No</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label for="infeccionembarazo2">
                                                                <input name="infeccionembarazo" id="infeccionembarazo2" value="1" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->infeccionUrinaria == 1? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>Sí</span>
                                                            </label>
                                                        </p>
                                                    ...
                                                    <div class="question">
                                                        ...
                                                        <p>
                                                            <label for="preclampsiaembarazo1">
                                                                <input name="preclampsiaembarazo" id="preclampsiaembarazo1" value="0" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->preeclampsia == 0? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>No</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label for="preclampsiaembarazo2">
                                                                <input name="preclampsiaembarazo" id="preclampsiaembarazo2" value="1" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->preeclampsia == 1? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>Sí</span>
                                                            </label>
                                                        </p>
                                                    ...
                                                    <div class="question">
                                                        ...
                                                        <p>
                                                            <label for="hemorragiaembarazo1">
                                                                <input name="hemorragiaembarazo" id="hemorragiaembarazo1" value="0" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->hemorragia == 0? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>No</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label for="hemorragiaembarazo2">
                                                                <input name="hemorragiaembarazo" id="hemorragiaembarazo2" value="1" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->hemorragia == 1? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>Sí</span>
                                                            </label>
                                                        </p>
                                                    ...
                                                    <div class="question">
                                                        ...
                                                        <p>
                                                            <label for="sospechacovidembarazo1">
                                                                <input name="sospechacovidembarazo" id="sospechacovidembarazo1" value="0" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->sospechaCovid == 0? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>No</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label for="sospechacovidembarazo2">
                                                                <input name="sospechacovidembarazo" id="sospechacovidembarazo2" value="1" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->sospechaCovid == 1? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>Sí</span>
                                                            </label>
                                                        </p>
                                                    ...
                                                    <div class="question">
                                                        ...
                                                        <p>
                                                            <label for="confirmacioncovidembarazo1">
                                                                <input name="confirmacioncovidembarazo" id="confirmacioncovidembarazo1" value="0" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->confirmaCovid == 0? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>No</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label for="confirmacioncovidembarazo2">
                                                                <input name="confirmacioncovidembarazo" id="confirmacioncovidembarazo2" value="1" type="radio" {{ $consulta->consultaembarazo != null? ($consulta->consultaembarazo->confirmaCovid == 1? "checked":""): ""}} {{ $consulta->consultaembarazo != null? "": "disabled"}}>
                                                                <span>Sí</span>
                                                            </label>
                                                        </p>
                                                    ...
                                                    <div class="collapsible-body">
                                                        <div class="row no-mar">
                                                            ...
                                                            <div
                                                                ...
                                                                <textarea name="otroshf" id="otroshf" cols="30" rows="10" maxlength="255"">{{ $anteHF->otros }}</textarea>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="collapsible-body">
                                                        <div class="row">
                                                            ...
                                                            <!--div class="col s12 m6 l6 txtarin no-mar default-select">
                                                                ...
                                                                <label class="label-flex" for="multiselecttoxic">
                                                                    <p class="text-over">
                                                                        Toxicomanías:
                                                                    </p>
                                                                </label>
                                                    ...
                                                    <div class="collapsible-body">
                                                        <div class="row no-mar">
                                                            ...
                                                            <div class="input-field col s12 m6 l6">
                                                                ...
                                                                <input name="peso" id="peso" data-id="price2" type="text" maxlength="6" class="validate" value="{{ $exploracion->peso }}">
                                                            ...
                                                            <div class="input-field col s12 m6 l6">
                                                                ...
                                                                <input name="talla" id="talla" data-id="price2" type="text" maxlength="3" class="validate" value="{{ $exploracion->talla }}"
