    ...
    <div class="wrapper">
        <div class="topbar-white">
            <div class="row center">
                ...
                <div class="col s6 vcenter fh righttop">
                    <a href="" class="dropdown-trigger rightbtn " data-target='dropdown1'><b>Administrador</b>{{ Auth::guard('eceadmin')->user()->name }}
                        <i class="material-icons">arrow_drop_down</i>
                    </a>
                    
                    <ul id='dropdown1' class='dropdown-content'>
                        <li><a href="{{ route('eceadmin.logout') }}"
                            onclick="event.preventDefault();
                            document.getElementById('logout-form').submit();"><i class="material-icons">exit_to_app</i>Cerrar sesión</a>
                        </li>
                            <form id="logout-form" action="{{ route('eceadmin.logout') }}" method="POST" class="d-none">
                                @csrf
                            </form>
                      </ul>
                </div>
        ...
        <div class="dashboard-home">
            ...
            <div class="dashboard-wrapper">
                <div class="sidebar">
                    <div class="side-menu">
                        <a href="{{ route('eceadmin.home') }}" class="side-btn {{ session('menunav') == "inicio" ? 'active' : ''}}">
                            <i class="material-icons">home</i>
                            <p>Inicio</p>
                        </a>
                        <a href="{{ route('eceadmin.tenants') }}" class="side-btn {{ session('menunav') == "tenants" ? 'active' : ''}}">
