...
<head>
    ...
    <script src="{{ asset('js/consulta.js')."?v=1.18" }}" defer></script> <!-- Script para manejar las operaciones crud de consulta -->
    <script src="{{ asset('js/interrogatorio.js')."?v=1.18" }}" defer></script> <!-- Script para manejar las operaciones crud de interrogatorio -->
    <script src="{{ asset('js/exploracion.js')."?v=1.18" }}" defer></script> <!-- Script para manejar las operaciones crud de interrogatorio -->
    <script src="{{ asset('js/notifications.js')."?v=1.18" }}" defer></script> <!-- Script para manejar las notificaciones de consultas sin terminar -->
    ...
    <link href="{{ asset('css/myappstyle.css')."?v=1.18" }}" rel="stylesheet">
