...
<head>
    ...
    <script src="{{ asset('js/consulta.js')."?v=1.17" }}" defer></script> <!-- Script para manejar las operaciones crud de consulta -->
    <script src="{{ asset('js/interrogatorio.js')."?v=1.17" }}" defer></script> <!-- Script para manejar las operaciones crud de interrogatorio -->
    <script src="{{ asset('js/exploracion.js')."?v=1.17" }}" defer></script> <!-- Script para manejar las operaciones crud de interrogatorio -->
    <script src="{{ asset('js/notifications.js')."?v=1.17" }}" defer></script> <!-- Script para manejar las notificaciones de consultas sin terminar -->
    ...
    <link href="{{ asset('css/myappstyle.css')."?v=1.17" }}" rel="stylesheet">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm fixed-top">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ url('/home') }}">
                    <h4><b><i class="bi bi-house-door-fill"></i></b></h4>
                </a>
